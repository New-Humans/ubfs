...
class Province(Place):
	"""Provinces exist within territories, and can contain cities, villages, and structures
	...
	allowedChildEntities = [Spec.CITY, Spec.VILLAGE, Spec.STRUCTURE, Spec.RESTAURANT]
